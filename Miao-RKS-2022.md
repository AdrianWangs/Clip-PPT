...
<div class="mt-4 p-3 bg-blue-50 rounded text-sm">
  <p class="font-semibold">实验结果（20Newsgroups数据集）：</p>
  <p class="text-xs mt-1">• 搜索时间 &lt; 100ms</p>
  <p class="text-xs">• 搜索准确率与RKS相当</p>
  <p class="text-xs">• 支持高效动态更新</p>
</div>
...
<div class="flex justify-center items-center mt-4">
  <img src="https://cdn-mineru.openxlab.org.cn/result/2025-10-21/99ec5320-3a91-4791-a67b-f4c5f4535912/a36c1fb24cd44737174aa7a79c2efd5fc45555bcfe70cbe97a400bb2d4abee53.jpg" alt="文件更新示例" class="w-9/12">
</div>
...
**场景：** 将 $\mathbf{d}_1$ 修改为 $\mathbf{d}_1'$
